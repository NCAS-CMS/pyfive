...
def create_file(path):
    with h5py.File(path, "w") as f:
        ...
        attrs["vlen_unicode"] = "Hello" + chr(0x00A7)
        ...
        attrs.create("complex64_little", 123 + 456.0j, dtype="<c8")
        attrs.create("complex128_little", 123 + 456.0j, dtype="<c16")

        attrs.create("complex64_big", 123 + 456.0j, dtype="<c8")
        attrs.create("complex128_big", 123 + 456.0j, dtype="<c16")
