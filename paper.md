...
with user expectations is it is more equivalent to the behaviour of other packages like `h5py`.
...
Metadata can be repacked to the front of the file and variables can be rechunked and made continuous - 
